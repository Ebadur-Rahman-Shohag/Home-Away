    ...
    <section>
      ...
      <div className="border p-8 rounded-md ">
        ...
        <FormContainer action={updatePropertyAction}>
          ...
          <CounterInput detail="guests" defaultValue={property.colors} />
          <CounterInput detail="bedrooms" defaultValue={property.sizes} />
          <CounterInput detail="beds" defaultValue={property.types} />
